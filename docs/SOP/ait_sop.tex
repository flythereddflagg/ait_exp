...
will ensure consistent results with the lowest uncertainty possible.
	...
	\item Place lid on pressure vessel and secure in place with the 
		...
		\item Tighten all the pressure vessel clamps on the lip of the lid so 
            ...
            %(hand tight is all that is necessary but we talked about 
            % potentially using a torque wrench).
	...
	\item Pressurize vessel
        ...
        \item Slowly open the cylinder valve 
		...
		\item Adjust pressure in vessel using low pressure regulator until the    
            absolute pressure in the vessel is 1 atm (760 Torr)
		\end{itemize} 

...
\end{figure}
        ...
        \item Using the bracket, loosen the nut on top of the lid assembly and slide the 
...
\end{figure}
    ...
    \subsubsection{Connecting to the camera} 
        ...
        \item Press the "shutter/select" button to confirm your selection
            ...
            \end{itemize}
        \item Power on the tablet by holding down the power key (top, right side) until you see 

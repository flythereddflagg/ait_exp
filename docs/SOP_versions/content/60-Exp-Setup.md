...
![AIT Furnace](../media/Furnace_pic_diagram.jpg)<!--fig:furnace_pic -->
...
![GoPro&copy; HERO4 Session&trade; Camera Diagram](../media/Camera_diagram.jpg) <!--fig:cam_diag -->
...
![Foil Sandwiches between the O-ring and the TC outlet](../media/o_ring_on_foil.jpg) <!--fig:rupture_disk -->

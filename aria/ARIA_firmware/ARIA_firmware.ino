 ...
 *  for injecting a liquid compound sample into the furnace. The other should run 
 *  the sequence for introducing a solid sample. When the LEDs turn back on, it
 *  is an indication the cycle is complete.
 * ******************************************************************************
 */
#include <Stepper.h>
#include <Servo.h>

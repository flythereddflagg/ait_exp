...
class DAQGUI(Frame):
    ...
    def initUI(self):
        """ Initialize the Uself.ser Interface with all widgets. """
    ...
    def daq_loop(self):
        ...
        print "Getting data...%d" % self.recurse_counter,
        data1 = self.get_data()           # get data
        if data1 == None:
            return self.parent.after(1, self.daq_loop)
        ...
        self.parent.after(803, self.daq_loop) # loop
